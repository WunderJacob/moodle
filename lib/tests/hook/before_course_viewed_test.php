 ...
 *
 * @coversDefaultClass \core\hook\before_course_viewed
 *
 * @package    core_course
 * @copyright  2024 Jacob Viertel
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class before_course_viewed_test extends \advanced_testcase {
    /**
     * Test hook description.
     * @covers ::get_hook_description
     */
    public function test_hook_description() {
     ...
     */
    public function test_hook_tags() {
     ...
     * @covers ::__construct
     */
    public function test_hook_initialization() {
        $course = new \stdClass();
        $course->id = 1;
     ...
     */
    public function test_hook_dispatch() {
        $course = new \stdClass();
        $course->id = 1;
        $course->fullname = 'Test Course';
